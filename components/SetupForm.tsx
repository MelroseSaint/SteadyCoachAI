...
import { ArrowRight, MessageSquare, Mic, ChevronDown, Zap, BookOpen, Clock, BarChart } from 'lucide-react';
  ...
  return (
    <div className="w-full">
      <div className="mb-8 text-center">
        <h2 className="text-3xl font-normal text-gray-900 dark:text-white mb-3">Session Configuration</h2>
        <p className="text-gray-500 dark:text-zinc-400 text-lg">Set the context. The coach will adapt.</p>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-8">
        ...
        <div className="space-y-3">
            ...
            <div className="relative">
                <select
                    ...
                    className="w-full bg-white dark:bg-zinc-900/50 text-xl border-b border-gray-300 dark:border-zinc-700 py-3 pr-8 focus:border-gray-500 dark:focus:border-zinc-300 focus:outline-none transition-colors text-gray-900 dark:text-white appearance-none cursor-pointer"
                >
                ...
                <ChevronDown className="absolute right-0 top-4 text-gray-400 dark:text-zinc-500 pointer-events-none" size={20} />
            </div>
            ...
            {selectedRole === 'Other' && (
                <div className="animate-fade-in mt-2">
                    <input
                        ...
                        className="w-full bg-gray-50 dark:bg-zinc-800/50 text-lg border border-gray-300 dark:border-zinc-700 rounded-lg px-4 py-2 focus:border-blue-500 focus:outline-none transition-colors text-gray-900 dark:text-white placeholder-gray-500 dark:placeholder-zinc-500"
                        autoFocus
                    />
                </div>
            )}
                ...
                <div className="flex flex-col space-y-2">
                    {[
                        ...
                        >
                            ...
                            <span className={`text-[10px] uppercase tracking-wider ${practiceMode === m.id ? 'text-gray-300 dark:text-zinc-400' : 'text-gray-400 dark:text-zinc-600'}`}>{m.desc}</span>
                        </button>
                    ))}
                </div>
            </div>
                        ...
                        { id: 'deep', label: 'Deep', desc: 'Critical (BYOK)' }
                         ...
                         return (
                            ...
                            >
                                ...
                                <span className={`text-[10px] uppercase tracking-wider ${feedbackDepth === f.id ? 'text-gray-300 dark:text-zinc-400' : 'text-gray-400 dark:text-zinc-600'}`}>{f.desc}</span>
                            </button>
                         )
                    })}
                </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="space-y-3">
                ...
                className="w-full bg-transparent text-lg border-b border-gray-300 dark:border-zinc-700 py-2 focus:border-gray-500 dark:focus:border-zinc-300 focus:outline-none transition-colors text-gray-900 dark:text-zinc-100 placeholder-gray-400 dark:placeholder-zinc-600"
                placeholder="Name"
                />
            </div>
        ...
        <div className="space-y-3">
          ...
          <textarea
            ...
            rows={2}
            className="w-full bg-transparent text-base border-b border-gray-300 dark:border-zinc-700 py-2 focus:border-gray-500 dark:focus:border-zinc-300 focus:outline-none transition-colors text-gray-900 dark:text-zinc-200 placeholder-gray-400 dark:placeholder-zinc-600 resize-none"
        ...
        <div className="pt-6 flex justify-center">
            ...
            className="group flex items-center space-x-3 px-8 py-4 bg-gray-900 dark:bg-zinc-100 text-white dark:text-zinc-950 rounded-full font-semibold hover:bg-gray-800 dark:hover:bg-white transition-all disabled:opacity-50 disabled:cursor-not-allowed shadow-lg"
            >
